...
namespace homeWorkLesson5
{
    class Program
    {
        ...
        {
            string first = "bigusdickus";
            string second = "sukcidsugib";

            Console.WriteLine("Вас приветствует программа проверяюшая является ли одна строка перестановкой другой.");
